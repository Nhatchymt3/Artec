...
{
    public class AlbumPhotoDivingController : Controller
    {
        #region Field
        ...
        #region Ctor
        public AlbumPhotoDivingController(IProductService productService, IProductCategoryService productCategoryService,
        ...
        public ActionResult Edit(AlbumPhotoFormModel photoModel)
        {
            ...
            return RedirectToAction("Index","AlbumPhotoDiving");
        }
