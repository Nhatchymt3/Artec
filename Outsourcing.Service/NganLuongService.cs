...
namespace Outsourcing.Service
{
    ...
    {
        ResponseInfo GetUrlCheckout(RequestInfo requestContent, string payment_method = "NL");
        ResponseCheckOrder GetTransactionDetail(RequestCheckOrder info);
    }
    ...
    public class NganLuongService: INganLuongService
    {
        ...
        private static String HttpPost(string postData)
        {
            ...
            // Prepare web request...
            HttpWebRequest myRequest = (HttpWebRequest)WebRequest.Create("https://sandbox.nganluong.vn:8088/nl30/checkout.api.nganluong.post.php");
